...
it("afterAttributeName with = or \t\n\f", () => {
    let doc = parseHTML("<div class= \"bb\" id = \"a\" />")
}) 

it("beforeAttributeName with \t\n\f ", () => {
    let doc = parseHTML("<div   class = \"bb\" id = \"a\" />")
}) 

it("UnquotedAttributeValue / ", () => {
    let doc = parseHTML("<div   class  id=a/>")
}) 

it("UnquotedAttributeValue > ", () => {
    let doc = parseHTML("<div   class  id=a></div>")
}) 
